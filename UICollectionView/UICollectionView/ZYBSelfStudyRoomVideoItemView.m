//
//  ZYBSelfStudyRoomVideoItemView.m
//  UICollectionView
//
...
@interface ZYBSelfStudyRoomVideoItemView ()
...
@implementation ZYBSelfStudyRoomVideoItemView
...
- (void)setupUI {
    ...
    [self.allView addSubview:self.titleImageView];
    ...
    [self.allView addSubview:self.backView];
